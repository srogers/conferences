...
RSpec.describe OrganizersController, type: :controller do
  pending 'organizers currently are static'
  # fixtures :roles
  # fixtures :settings
  #
  ...
  #     it "finds organizers with matching titles without regard to case" do
  #       get :index, params:{ search_term: 'VALID' }
  #       expect(assigns(:organizers)).to eq([@organizer])
  #     end
  #
  #     it "it doesn't find non-matching organizers" do
  #       get :index, params:{ search_term: 'Wombats' }
  #       expect(assigns(:organizers)).to be_empty
  #     end
  #   end
  #
  #   context "with an auto-complete search term" do
  #     it "finds organizers with titles starting with the search term (case insensitive)" do
  #       get :index, params:{ q: 'VALID' }
  #       expect(assigns(:organizers)).to eq([@organizer])
  #     end
  #
  #     it "finds organizers with interior words starting with the search term" do
  #       get :index, params:{ q: 'organizer' }
  #       expect(assigns(:organizers)).to eq([@organizer])
  #     end
  #
  #     it "it doesn't find non-matching organizers" do
  ...
  #     end
  #
  #     it "it doesn't find excluded organizers" do
  #       get :index, params:{ q: 'valid', exclude: @organizer.id }
  #       expect(assigns(:organizers)).to be_empty
  #     end
  #   end
  # end
